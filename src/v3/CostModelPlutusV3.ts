...
// 350-entry V3 cost model — fields are listed in chain canonical order
// (matches the iteration order of defaultV3Costs and the positional CBOR
// layout in toCostModelArrV3). Re-derived from preprod blockfrost cost_models.PlutusV3.
