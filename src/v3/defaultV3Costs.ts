...
// 350-entry V3 cost model — Plomin² governance-extended cost model active on
// preprod since epoch 289 boundary (2026-05-16). Generated from blockfrost
// /epochs/latest/parameters; key order matches chain canonical order, which is
// what costModelsToLanguageViewCbor must emit to compute matching script_data_hash.
