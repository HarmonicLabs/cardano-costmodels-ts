...
export type CostModelPlutusV3Array = CanBeUInteger[] & { length: 223 };
...
export const defaultV3Costs: CostModelPlutusV3 = Object.freeze({
    ...
    "verifySchnorrSecp256k1Signature-cpu-arguments-slope": 32947,
    "verifySchnorrSecp256k1Signature-memory-arguments": 10,
    // TODO: update with real costs as soon as I can find them somewhere
    "cekConstrCost-exBudgetCPU": 30_000_000_000,
    "cekConstrCost-exBudgetMemory": 30_000_000_000,
    "cekCaseCost-exBudgetCPU": 30_000_000_000,
    "cekCaseCost-exBudgetMemory": 30_000_000_000,
    "bls12_381_G1_add-cpu-arguments": 30_000_000_000,
    "bls12_381_G1_add-memory-arguments": 30_000_000_000,
    "bls12_381_G1_compress-cpu-arguments": 30_000_000_000,
    "bls12_381_G1_compress-memory-arguments": 30_000_000_000,
    "bls12_381_G1_equal-cpu-arguments": 30_000_000_000,
    "bls12_381_G1_equal-memory-arguments": 30_000_000_000,
    "bls12_381_G1_hashToGroup-cpu-arguments-intercept": 30_000_000_000,
    "bls12_381_G1_hashToGroup-cpu-arguments-slope": 30_000_000_000,
    "bls12_381_G1_hashToGroup-memory-arguments": 30_000_000_000,
    "bls12_381_G1_neg-cpu-arguments": 30_000_000_000,
    "bls12_381_G1_neg-memory-arguments": 30_000_000_000,
    "bls12_381_G1_scalarMul-cpu-arguments-intercept": 30_000_000_000,
    "bls12_381_G1_scalarMul-cpu-arguments-slope": 30_000_000_000,
    "bls12_381_G1_scalarMul-memory-arguments": 30_000_000_000,
    "bls12_381_G1_uncompress-cpu-arguments": 30_000_000_000,
    "bls12_381_G1_uncompress-memory-arguments": 30_000_000_000,
    "bls12_381_G2_add-cpu-arguments": 30_000_000_000,
    "bls12_381_G2_add-memory-arguments": 30_000_000_000,
    "bls12_381_G2_compress-cpu-arguments": 30_000_000_000,
    "bls12_381_G2_compress-memory-arguments": 30_000_000_000,
    "bls12_381_G2_equal-cpu-arguments": 30_000_000_000,
    "bls12_381_G2_equal-memory-arguments": 30_000_000_000,
    "bls12_381_G2_hashToGroup-cpu-arguments-intercept": 30_000_000_000,
    "bls12_381_G2_hashToGroup-cpu-arguments-slope": 30_000_000_000,
    "bls12_381_G2_hashToGroup-memory-arguments": 30_000_000_000,
    "bls12_381_G2_neg-cpu-arguments": 30_000_000_000,
    "bls12_381_G2_neg-memory-arguments": 30_000_000_000,
    "bls12_381_G2_scalarMul-cpu-arguments-intercept": 30_000_000_000,
    "bls12_381_G2_scalarMul-cpu-arguments-slope": 30_000_000_000,
    "bls12_381_G2_scalarMul-memory-arguments": 30_000_000_000,
    "bls12_381_G2_uncompress-cpu-arguments": 30_000_000_000,
    "bls12_381_G2_uncompress-memory-arguments": 30_000_000_000,
    "bls12_381_finalVerify-cpu-arguments": 30_000_000_000,
    "bls12_381_finalVerify-memory-arguments": 30_000_000_000,
    "bls12_381_millerLoop-cpu-arguments": 30_000_000_000,
    "bls12_381_millerLoop-memory-arguments": 30_000_000_000,
    "bls12_381_mulMlResult-cpu-arguments": 30_000_000_000,
    "bls12_381_mulMlResult-memory-arguments": 30_000_000_000,
    "keccak_256-cpu-arguments-intercept": 30_000_000_000,
    "keccak_256-cpu-arguments-slope": 30_000_000_000,
    "keccak_256-memory-arguments": 30_000_000_000,
    "blake2b_224-cpu-arguments-intercept": 30_000_000_000,
    "blake2b_224-cpu-arguments-slope": 30_000_000_000,
    "blake2b_224-memory-arguments": 30_000_000_000,
    "integerToByteString-cpu-arguments-c0": 30_000_000_000,
    "integerToByteString-cpu-arguments-c1": 30_000_000_000,
    "integerToByteString-cpu-arguments-c2": 30_000_000_000,
    "integerToByteString-memory-arguments-intercept": 30_000_000_000,
    "integerToByteString-memory-arguments-slope": 30_000_000_000,
    "byteStringToInteger-cpu-arguments-c0": 30_000_000_000,
    "byteStringToInteger-cpu-arguments-c1": 30_000_000_000,
    "byteStringToInteger-cpu-arguments-c2": 30_000_000_000,
    "byteStringToInteger-memory-arguments-intercept": 30_000_000_000,
    "byteStringToInteger-memory-arguments-slope": 30_000_000_000,
...
{    
    const costs = toCostModelV2( costmdlsV2 );
...
export function costModelsToCborObj( costmdls: CostModels ): CborMap
{
    ...
    return new CborMap([
        ...
        {
            k: new CborUInt( 2 ),
            v: new CborArray( toCostModelArrV3( PlutusScriptV3 ).map( n => new CborUInt( forceBigUInt( n ) ) ) )
        }
...
export function costModelsToLanguageViewCbor( costmdls: CostModels, opts: CostModelsToLanguageViewCborOpts ): CborString
{
    ...
    return Cbor.encode(
        new CborMap([
            ...
            {
                k: new CborUInt(2),
                v: new CborArray( toCostModelArrV3( PlutusScriptV3 as any ).map( n => new CborUInt( forceBigUInt( n ) ) ) )
            } : undefined
        ].filter( elem => elem !== undefined ) as CborMapEntry[])
    )
}
...
export function costModelsToJson( costmdls: CostModels )
{
    ...
    if( _pv3 !== undefined )
    {
        const ks = Object.keys( _pv3 ) as (keyof CostModelPlutusV2)[];
        const n = ks.length;
        for(let i = 0; i < n; i++)
        {
            defineReadOnlyProperty(
                pv3, ks[i], forceBigUInt( _pv3[ks[i]] ).toString()
            )
        }
    }
...
export function toCostModelV3( v3: AnyV3CostModel ): CostModelPlutusV3
{
    ...
    if( v3.length < 223 )
    throw new Error(
        "impossible to convert cost model v3 array to object; not enough arguments; arguments found in total: " + v3.length.toString()
    );
...
export function toCostModelArrV3( v3: AnyV3CostModel ): CostModelPlutusV3Array
{
    ...
    return Object.freeze([
        ...
        v3["divideInteger-cpu-arguments-model-arguments-intercept"],
        v3["divideInteger-cpu-arguments-model-arguments-slope"],
        ...
        v3["modInteger-cpu-arguments-model-arguments-intercept"],
        v3["modInteger-cpu-arguments-model-arguments-slope"],
        v3["modInteger-memory-arguments-intercept"],
        v3["modInteger-memory-arguments-minimum"],
        ...
        v3["quotientInteger-cpu-arguments-model-arguments-intercept"],
        v3["quotientInteger-cpu-arguments-model-arguments-slope"],
        ...
        v3["remainderInteger-cpu-arguments-model-arguments-intercept"],
        v3["remainderInteger-cpu-arguments-model-arguments-slope"],
        v3["remainderInteger-memory-arguments-intercept"],
        v3["remainderInteger-memory-arguments-minimum"],
...
// CAN NOT extend CostModelPlutusV2 because ORDER CAHNGES
